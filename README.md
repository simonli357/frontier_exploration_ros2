...
| `frontier_candidate_max_span_m`             | `double` | `0.0`   | Maximum XY span of one frontier candidate; zero disables spatial partitioning                             | Split large connected frontier boundaries so suppression of one blocked approach does not suppress every alternative along that boundary                                                                                                                                                                                     |
