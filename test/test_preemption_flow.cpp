...
TEST(PreemptionFlowTests, FrontierDispatchUsesCostmapSafeStandoffForFarTarget)
{
  FrontierExplorerCoreParams params;
  params.frontier_selection_min_distance = 0.5;
  params.frontier_goal_standoff_m = 2.0;
